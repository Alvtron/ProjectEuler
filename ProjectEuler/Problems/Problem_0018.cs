...
namespace ProjectEuler.Problems
{
    ...
    {
        private static readonly string QuestionFilePath = Path.Combine(Environment.CurrentDirectory, @"resources\problem_0018_question.txt");
        private static readonly string NumbersFilePath = Path.Combine(Environment.CurrentDirectory, @"resources\problem_0018_triangle.txt");
        ...
        public override Answer Answer => 1074;
